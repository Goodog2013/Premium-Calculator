...
export function ExpressionDisplay({
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-300/70 bg-white/70 p-5 shadow-soft backdrop-blur-xl dark:border-slate-700 dark:bg-slate-900/60">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-[rgb(var(--accent-soft-rgb)/0.6)] via-transparent to-transparent dark:from-[rgb(var(--accent-rgb)/0.2)]" />
      ...
      <div className="min-h-[70px] rounded-2xl bg-gradient-to-br from-white/80 to-[rgb(var(--accent-soft-rgb)/0.45)] p-4 dark:from-slate-800/80 dark:to-[rgb(var(--accent-rgb)/0.18)]">
        ...
        <p className="accent-note mt-1 h-5 overflow-hidden text-ellipsis whitespace-nowrap font-mono text-xs">
      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-slate-300/70 px-3 py-2 text-xs font-semibold text-slate-700 transition accent-border-hover hover:text-slate-900 dark:border-slate-700 dark:text-slate-200 dark:hover:text-white"
          >
          ...
          <button
            type="button"
            onClick={onCopy}
            className="accent-soft inline-flex items-center gap-2 rounded-xl border px-3 py-2 text-xs font-semibold transition"
          >
